...
import { useUserLazyQuery, useUserQuery } from "../../generated/graphql";
...
function Login() {
  ...
  async function handleClick() {
    ...
    // fetch("http://localhost:8000/api/users/address/" + checkSum)
    ...
    //       window.alert(
    //         "Sorry but we're having troubles connecting to our services right now. Please try again later. Check our social media for updates on this issue @NFTeaseApp."
    //       );
